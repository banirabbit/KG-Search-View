...
import { updateEdgeData } from "../../../../actions/graphProjectAction";
interface props {
  open: boolean;
  setOpen: any;
}
export default function AddEdgeDialog({ open, setOpen }: props) {
  const handleClose = () => {
    setOpen(false);
    setAddClick(false)
  };
  ...
  return (
    <React.Fragment>
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <DialogContentText>加入一组关系</DialogContentText>
          <TextField
            autoFocus
            required
            margin="dense"
